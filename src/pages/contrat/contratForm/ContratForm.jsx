...
import { Form, Input, DatePicker, Select, Button, TextArea, notification } from 'antd';
    ...
    <div className="controle_form">
        ...
        <div className="controle_wrapper">
            ...
            >
                ...
                <Form.Item label="ID Client" name="id_client" rules={[{ required: true, message: 'Veuillez entrer l\'ID client!' }]}>
                <Input type="number" value={formData.id_client} onChange={handleChange} />
                </Form.Item>

                <Form.Item label="Date de début" name="date_debut" rules={[{ required: true, message: 'Veuillez sélectionner une date de début!' }]}>
                <DatePicker
                ...
                <Form.Item label="Date de fin" name="date_fin" rules={[{ required: true, message: 'Veuillez sélectionner une date de fin!' }]}>
                <DatePicker
                ...
                <Form.Item label="Montant" name="montant" rules={[{ required: true, message: 'Veuillez entrer le montant!' }]}>
                <Input
                    type="number"
                ...
                <Form.Item label="Type de contrat" name="type_contrat" rules={[{ required: true, message: 'Veuillez sélectionner le type de contrat!' }]}>
                <Select
                ...
                <Form.Item label="Date de signature" name="date_signature" rules={[{ required: true, message: 'Veuillez sélectionner la date de signature!' }]}>
                <DatePicker
