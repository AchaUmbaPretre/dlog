  ...
  return (
    <>
      ...
      <Modal
        ...
        centered
      >
        <InstructionForm closeModal={closeAllModals} fetchData={fetchData} idInspection={''} idTache={null}/>
      </Modal>
      <Modal
        title=""
        ...
        centered
      >
        <InstructionFormEdit closeModal={closeAllModals} fetchData={fetchData} idInspection={idInspection}/>
      </Modal>
