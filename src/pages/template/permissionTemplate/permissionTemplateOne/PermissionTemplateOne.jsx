...
const PermissionTemplateOne = ({idTemplate, idUser}) => {
...
/*                 if(idDeclaration){
    ...
    const handlePermissionChange = async (idTemplate, idUser, field, value) => {
        console.log(idTemplate, idUser, field, value);
...
export default PermissionTemplateOne;