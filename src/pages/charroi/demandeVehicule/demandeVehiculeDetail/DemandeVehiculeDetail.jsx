...
const DemandeVehiculeDetail = ({ id_demande_vehicule }) => {
  ...
  return (
    ...
    >
      ...
      <Descriptions.Item label="Date de chargement">{new Date(data.date_chargement).toLocaleString()}</Descriptions.Item>
      <Descriptions.Item label="Date prévue">{new Date(data.date_prevue).toLocaleString()}</Descriptions.Item>
      <Descriptions.Item label="Date de retour">{new Date(data.date_retour).toLocaleString()}</Descriptions.Item>
