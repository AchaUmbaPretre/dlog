...
//Rapport ville
export const getRapportVille = async () => {
  return axios.get(`${DOMAIN}/api/template/rapport_ville`);
};
...
//Rapport Entreposage
export const getRapportEntreposage = async () => {
  return axios.get(`${DOMAIN}/api/template/rapport_entreposage`);
};
